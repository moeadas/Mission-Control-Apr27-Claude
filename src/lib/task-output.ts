...
export function getDeliverableOutputSpec(deliverableType: DeliverableType, request: string) {
  ...
  if (deliverableType === 'blog-article') {
    return [
      ...
      'Follow the complete content writer checklist as hard requirements: research, search intent, title, slug, meta, intro, structure, TOC, keyword usage, E-E-A-T, visual suggestions, linking, AEO/GEO, conclusion, pre-publish checks, and after-publish maintenance.',
      'Unless the user asks for a shorter article, the Article Draft itself must be a substantive long-form draft of at least 2,000 words, modeled after a high-scoring SEO article with deep sections, FAQs, examples, comparison content, and a strong CTA. Do not provide only an outline or short sample.',
      'Output sections in this exact order:',
      '## Objective',
      'Summarize the purpose of the article and the business goal in 2-3 sentences.',
      '## Search Intent & SERP Notes',
      'Summarize search intent and useful SERP/PAA insights in a compact paragraph or short bullets.',
      '## SEO Package',
      'Include exactly these labeled fields first: Primary Keyword, Secondary Keywords, SEO Title, URL Slug, Meta Description. Then include 5 SEO title options, target audience, and suggested word count.',
      '## Article Outline',
      'Include H1, H2/H3 hierarchy, and table of contents anchors.',
      '## Table of Contents',
      'Include markdown anchor-style links to every major article section. Do not output raw HTML anchor tags.',
      '## Key Takeaways',
      '## Article Draft',
      'The draft must be one continuous copy-and-paste-ready post, similar to a published high-scoring SEO blog article. It must include a single article H1, last updated / author / reading time line when client context supports it, a natural "Quick Navigation" line or section inside the post body, key takeaways, the primary keyword naturally in the first 100 words, a 40-60 word direct answer near the top, short paragraphs, useful H2/H3s, at least one comparison table or callout, FAQ, a final summary, author/about note when client context supports it, and a natural CTA. Do not split the article into separate cards, fragments, planning notes, or standalone sections inside the Article Draft. Do not use the heading "Table of Contents" inside the Article Draft. Do not include raw <a id="..."></a> anchor tags.',
      '## FAQ',
