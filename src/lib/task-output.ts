...
export function getDeliverableOutputSpec(deliverableType: DeliverableType, request: string) {
  ...
  if (deliverableType === 'blog-article') {
    return [
      ...
      'Unless the user asks for a shorter article, the Article Draft itself must be a substantive long-form draft of at least 1,200 words. Do not provide only an outline or short sample.',
      'Output sections in this exact order:',
      '## Objective',
      ...
      '## Key Takeaways',
      '## Article Draft',
      'The draft must be one continuous copy-and-paste-ready post, similar to a published SEO blog article. It must include a single article H1, last updated / author / reading time line when client context supports it, a natural "Quick Navigation" section inside the post body, key takeaways, the primary keyword naturally in the first 100 words, a 40-60 word direct answer near the top, short paragraphs, useful H2/H3s, at least one comparison table or callout, FAQ, a final summary, author/about note when client context supports it, and a natural CTA. Do not split the article into separate cards or fragments. Do not use the heading "Table of Contents" inside the Article Draft. Do not include raw <a id="..."></a> anchor tags.',
      '## FAQ',
