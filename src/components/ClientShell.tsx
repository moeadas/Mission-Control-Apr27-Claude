...
export function ClientShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = useAgentsStore.subscribe((state) => {
      ...
      saveTimer = setTimeout(async () => {
        ...
        const snapshot = createRemoteAppPersistenceSnapshot(state)
  ...
  return (
    <div className="mission-shell relative flex h-screen flex-col overflow-hidden bg-[var(--bg-base)]">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-[size:32px_32px] opacity-30" />
      <a
        href="#main-content"
      ...
      <button
        ...
        style={{ boxShadow: '0 18px 36px rgba(79, 142, 247, 0.28)' }}
      >
